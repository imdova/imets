...
export default function Singlecompany({ params }: SinglecompanyProps) {
  ...
  const company = companies.find((company) => company.id === slug);
  if (!company) {
    return notFound;
  }
          ...
          <div>
            ...
            <div className="mt-2 flex gap-4">
              ...
              <div className="flex items-center gap-1 text-sm text-gray-500">
                {company.rating} <Star className="text-secondary" size={13} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-fit rounded-lg border border-gray-200 bg-white shadow-sm lg:col-span-3">
          <div className="border-b border-gray-200 p-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2 text-sm">
                <MapPin size={15} />
                <p className="text-gray-500">{company.location.country}</p>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Calendar size={15} />
                ...
                return (
                  ...
                  >
                    <Image
                      ...
                      src={company.avatar ?? "/images/placeholder.png"}
                      width={200}
                      height={200}
                      alt={company.name}
                    />
