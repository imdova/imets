...
import StatsTwoCard from "@/components/UI/cards/StatsTwoCard";
        ...
        primaryActions: [
          {
            ...
            icon: <Edit size={16} />,
            onClick: (item: Leave) =>
              alert(`Edit ${item.employee.name}'s leave`),
          },
          {
            label: "Delete",
            icon: <Trash2 size={16} />,
            onClick: (item: Leave) => {
              if (
                confirm(
                  `Are you sure you want to delete ${item.employee.name}'s leave?`,
                )
              ) {
                alert(`Delete ${item.employee.name}'s leave`);
              }
            },
          },
        ],
