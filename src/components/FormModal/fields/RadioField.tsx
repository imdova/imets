      ...
      <div className="flex w-full flex-wrap gap-2">
        {options?.map((option) => (
          <div
            ...
            className={`flex-center group flex h-[42px] min-w-24 items-center gap-2 rounded-base border px-4 font-normal hover:cursor-pointer focus:outline-offset-2 focus:outline-light-primary
            ${
              error
