  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className={cn(
          "w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-left",
          "focus:outline-none",
          "transition-all duration-200 ease-in-out",
          !!dependsOn && "cursor-not-allowed bg-gray-100 text-gray-400",
        )}
        ...
        >
          {options?.map((option) => (
            <div
              ...
              className={cn(
                "flex cursor-pointer items-center gap-2 px-4 py-2.5 hover:bg-gray-50",
